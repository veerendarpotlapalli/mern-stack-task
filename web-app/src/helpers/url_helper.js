...
// SALES ORDER
export const GET_SALES_ORDER = "/api/employee";
export const GET_SINGLE_SALES_ORDER = "/api/sales/one-salesorder";
export const START_PICKING_PROCESS = "/api/sales/pick-start";
export const SCAN_WITH_BARCODE = "/api/order-item/multiple-barcode";
...
export const GET_VERIFY_LIST = "/api/sales/verifier-order"
//PROFILE
...
export const CREATE_EMPLOYE = "/api/employee/create";
export const UPDATE_EMPLOYE = "/api/employee/update";
export const DELETE_EMPLOYE = "/api/employee/delete";
