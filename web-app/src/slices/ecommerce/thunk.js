...
import {
  createEmploye as createEmployeApi,
  ...
  editEmploye as editEmployeApi,
  deleteEmploye as deleteEmployeApi
} from "../../helpers/fakebackend_helper";

export const createEmploye = createAsyncThunk("ecommerce/createEmploye", async (data) => {
  try {
    const response = createEmployeApi(data);
    return response;
  } catch (error) {
    return error;
  }
...
export const editEmploye = createAsyncThunk("ecommerce/editEmploye", async (data) => {
  try {
    const response = editEmployeApi(data);
    return response;
  } catch (error) {
    return error;
  }
...
export const deleteEmploye = createAsyncThunk("ecommerce/deleteEmploye", async (data) => {
  try {
    const response = deleteEmployeApi(data);
    return response;
  } catch (error) {
    return error;
  }
